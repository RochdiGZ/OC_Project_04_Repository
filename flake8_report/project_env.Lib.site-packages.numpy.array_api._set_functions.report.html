      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="project_env.Lib.site-packages.numpy.array_api._set_functions.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="project_env.Lib.site-packages.numpy.array_api._set_functions.source.html#l21">
                  <tt><i>21</i> <span class="k">class</span> <span class="nc">UniqueAllResult</span><span class="p">(</span><span class="n">NamedTuple</span><span class="p">):</span></tt>
               </a>
            </li>
            </ul>
         </li>
