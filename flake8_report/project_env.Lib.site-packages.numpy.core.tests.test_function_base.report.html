      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="project_env.Lib.site-packages.numpy.core.tests.test_function_base.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="project_env.Lib.site-packages.numpy.core.tests.test_function_base.source.html#l405">
                  <tt><i>405</i>                     </tt>
               </a>
            </li>
            </ul>
