...
<html>
   <head>
      <title>flake8 violations: project_env\Lib\site-packages\dill\tests\__init__.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="project_env.Lib.site-packages.dill.tests.__init__.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               project_env\Lib\site-packages\dill\tests\__init__.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="project_env.Lib.site-packages.dill.tests.__init__.source.html#l21">
                  <tt><i>21</i> <span class="sd">  $ nosetests  </span></tt>
               </a>
            </li>
            </ul>
         </li>
