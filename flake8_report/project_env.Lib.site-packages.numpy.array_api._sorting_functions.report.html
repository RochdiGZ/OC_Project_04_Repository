      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="project_env.Lib.site-packages.numpy.array_api._sorting_functions.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="project_env.Lib.site-packages.numpy.array_api._sorting_functions.source.html#l36">
                  <tt><i>36</i> <span class="k">def</span> <span class="nf">sort</span><span class="p">(</span></tt>
               </a>
            </li>
            </ul>
         </li>
